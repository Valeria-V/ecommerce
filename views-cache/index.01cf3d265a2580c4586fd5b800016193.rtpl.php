        ...
        <div class="block-slider block-slider4">
            <ul class="" id="bxslider-home4">
                ...
                <li><img src="res/site/img/h4-slide2.png" alt="Slide">
                    <div class="caption-group">
                        <h2 class="caption title">
                            Compre e ganhe <span class="primary">50% <strong>off</strong></span>
                        </h2>
                        <h4 class="caption subtitle">em itens escolares e mochilas.*</h4>
                        <a class="caption button-radius" href="#"><span class="icon"></span>Comprar</a>
                    </div>
                </li>
                <li><img src="res/site/img/h4-slide3.png" alt="Slide">
                    <div class="caption-group">
                        ...
                        <h4 class="caption subtitle">Selecione o modelo</h4>
                        <a class="caption button-radius" href="#"><span class="icon"></span>Comprar</a>
                    </div>
                </li>
                <li><img src="res/site/img/h4-slide4.png" alt="Slide">
                    <div class="caption-group">
                      <h2 class="caption title">
                        ...
                        <h4 class="caption subtitle">+ Fone</h4>
                        <a class="caption button-radius" href="#"><span class="icon"></span>Comprar</a>
                    </div>
                </li>
            </ul>
                        ...
                        <div class="single-product">
                            <div class="product-f-image">
                                ...
                                <div class="product-hover">
                                    ...
                                    <a href="#" class="view-details-link"><i class="fa fa-link"></i> Mais detalhes</a>
                                </div>
                            </div>
                            
                            <h2><a href="#">Samsung Galaxy S5</a></h2>
